...
1. Read the builder example in [README.md](../README.md)
2. Follow [Your First Graph](first-graph.md)
3. Pick a model setup in [Choose a Backend](choose-backend.md)
4. Learn debugging in [Observability](observability.md)
5. Open the browser debugger in [Visualizer Web UI](visualizer-web-ui.md)
