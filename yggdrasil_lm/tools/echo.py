...
async def echo(input: dict[str, Any]) -> str:  #6 (line in Coconut source)
    """Simple echo tool for testing."""  #7 (line in Coconut source)
    return "Echo: {_coconut_format_0}".format(_coconut_format_0=(input))  #8 (line in Coconut source)
