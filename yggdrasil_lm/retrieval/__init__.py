...
from yggdrasil_lm.retrieval.wrrf import RetrievalResult  #5 (line in Coconut source)
from yggdrasil_lm.retrieval.wrrf import semantic_search  #5 (line in Coconut source)

__all__ = ["Embedder", "RetrievalResult", "semantic_search"]  #7 (line in Coconut source)


def __getattr__(name: str) -> Any:  #10 (line in Coconut source)
    _coconut_case_match_to_0 = name  #11 (line in Coconut source)
    _coconut_case_match_check_0 = False  #11 (line in Coconut source)
    if _coconut_case_match_to_0 == "Embedder":  #11 (line in Coconut source)
        _coconut_case_match_check_0 = True  #11 (line in Coconut source)
    if _coconut_case_match_check_0:  #11 (line in Coconut source)
        from yggdrasil_lm.retrieval.embedder import Embedder  #13 (line in Coconut source)
        return Embedder  #14 (line in Coconut source)
    if not _coconut_case_match_check_0:  #15 (line in Coconut source)
        ...
        if _coconut_case_match_check_0:  #15 (line in Coconut source)
            raise AttributeError(name)  #16 (line in Coconut source)
